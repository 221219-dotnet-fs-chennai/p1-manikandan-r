...
namespace UI_Console
{
    internal class TrainerDelete : SignUp, IMenu
    {
        ...
        public new void Display()
        {
            ...
            Console.WriteLine("[4] UG college name          : " + education.Ug_collage);
            Console.WriteLine("[5] UG stream                : " + education.Ug_stream);
            Console.WriteLine("[6] UG percentage            : " + education.Ug_percentage);
            Console.WriteLine("[7] UG year                  : " + education.Ug_year);
            Console.WriteLine("[8] PG college name          : " + education.Pg_collage);
            Console.WriteLine("[9] PG stream                : " + education.Pg_stream);
            Console.WriteLine("[10] PG percentage           : " + education.Pg_percentage);
            Console.WriteLine("[11] PG year                 : " + education.Pg_year);
            Console.WriteLine("[12] Skill 1                 : " + skill.Skill_1);
            Console.WriteLine("[13] Skill 2                 : " + skill.Skill_2);
            Console.WriteLine("[14] Skill 3                 : " + skill.Skill_3);
            Console.WriteLine("[15] Company name            : " + company.Companyname);
            Console.WriteLine("[16] Field                   : " + company.Field);
            Console.WriteLine("[17] Overall Experience      : " + company.Experience);
        }
